...
var addJs=function(){		//initial add jqury.js lodash.js
...
var table=[];
function loading(){
	addJs("javascript/lib/jquery.js","javascript/lib/lodash.js");
	addCss("css/sorter.css");
	setTimeout('$("table").each(function(i){table[i]=new createTable(this); });', 500);
}
